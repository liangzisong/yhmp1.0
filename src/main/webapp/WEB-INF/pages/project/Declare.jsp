		...
		<div class="row clearfix">
			...
			<div class="col-md-8 column">
				...
				<form role="form">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">项目标准分:</label>
						<div class="col-sm-10">
					...
					<div class="form-group" id="contract">
						<label class="col-sm-2 control-label">合同签订情况:</label>
						&nbsp;&nbsp;&nbsp;&nbsp;
				  ...
				  <div class="form-group" id="quality" >
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select id="responsibilityName" style="z-index:9999;position: relative;" class="form-control required datepickers">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="responsibilityPhone" style="z-index:9998;position: relative;" />
						</div>
					</div>
					<div class="col-md-9 column">
						<div class="row clearfix">
							...
							<div class="col-md-9 column">
								<br> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" class="btn btn-default" id="table1-submit" style="z-index:9998;position: relative;" >提交</button>
							</div>
						</div>
					</div>
				</form>
