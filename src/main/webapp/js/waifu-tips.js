...
$('.waifu-tool .fui-info-circle').click(function (){
    ...
    window.open('https://www.xiaoweigod.com/share/1526.html');
});
...
function showHitokoto(){
    $.getJSON('//api.fghrsh.net/hitokoto/rand/?encode=jsc&uid=3335',function(result){
        var text = '这句一言出处是 <span style="color:#0099cc;">『{source}』</span>，是 <span style="color:#0099cc;">小伟博客</span> 在 {date} 收藏的！';
